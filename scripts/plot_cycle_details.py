...
# ── INPUT ─────────────────────────────────────────────────────────────────────
POWER_CURVE_FILE = Path("results/power_curves.yml")
PROFILE_ID = 2           # int profile_id to filter on; None = use all profiles
WIND_SPEED_MIN = None    # float [m/s], None = no lower limit
WIND_SPEED_MAX = None    # float [m/s], None = no upper limit
OUTPUT_DIR = Path("results/cycle_details.yml")  # folder to save PDFs; None = show only
SHOW_PLOT = False
# ──────────────────────────────────────────────────────────────────────────────
